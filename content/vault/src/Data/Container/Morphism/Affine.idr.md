## Lenses as data accessors

Lenses as data accessors gave rise to an entire family of lens-like objects that deal with different structures and patterns of data types. In this section, I will show how the existing family of lenses, often called _optics_, can be recovered from our formulation of them as container morphisms.
...
The maybe monad on containers is defined as both `Maybe c = 1 + c` and `Maybe c = MaybeCont \circ c `
...
### Opinion piece: Prisms are ill-defined
```idris
---------------------------------------------------------------------------------
