...
Cartesian container morphisms come from Abbott (do they?) where the name was
given by the fact that the something something cartesian morphisms pullbacks.

In the programming practice, this means that the backward map of lenses is an
_isomorphism_ rather than a one-way morphism. All the naming conventions for
